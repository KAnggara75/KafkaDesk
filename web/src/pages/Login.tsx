...
const Login: React.FC = () => {
	...
	return (
		<div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-slate-900 transition-colors duration-300">
			<div className="w-full max-w-md p-8 space-y-6 bg-white dark:bg-dark rounded shadow-md transition-colors duration-300">
				...
				<form className="space-y-4" onSubmit={handleSubmit}>
					<div>
						...
						<input
							type="text"
							required
							className="w-full px-3 py-2 mt-1 border border-gray-300 dark:border-slate-600 rounded-md bg-white dark:bg-darklight text-slate-900 dark:text-slate-100 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-blue-500 dark:focus:border-blue-400 transition-colors"
							value={username}
